...
class IntelligenceCard {
  ...
  IntelligenceCard copyWith({
    ...
    return IntelligenceCard(
      ...
      credibilityType: credibilityType ?? this.credibilityType,
      source: source ?? this.source,
      readTime: readTime ?? this.readTime,
      transparencyReason: transparencyReason ?? this.transparencyReason,
      pros: pros ?? this.pros,
      cons: cons ?? this.cons,
      channelId: channelId ?? this.channelId,
      userFeedback: userFeedback ?? this.userFeedback,
      groundedContext: groundedContext ?? this.groundedContext,
      url: url ?? this.url,
